...
| TikTok photo slideshows (optional) | [`gallery-dl`](https://github.com/mikf/gallery-dl) on PATH (`pipx install gallery-dl` / `brew install gallery-dl`); used only when yt-dlp returns no video | Free |
