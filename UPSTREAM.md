...
| [#220](https://github.com/bradautomates/claude-video/pull/220) | @Rasmus257 | feat(download): Support for TikTok photo slideshows | **adapted** | audio-only crash fixed; gallery-dl slideshow support deferred → [frinsen#11](https://github.com/frinsen/claude-video/issues/11) |
...
| [#115](https://github.com/bradautomates/claude-video/pull/115) | @yejoopapa | Restore YouTube caption retrieval past the PO-token gate | **deferred** | forces `player_client=default,tv,web_safari` on every caption fetch; needs evidence it helps beyond the media retry → [frinsen#14](https://github.com/frinsen/claude-video/issues/14) |
| [#152](https://github.com/bradautomates/claude-video/pull/152) | @binyangzhu000-sudo | feat: add Atlas Cloud ASR transcription backend | **deferred** | Atlas Cloud ASR vendor service; same → [frinsen#13](https://github.com/frinsen/claude-video/issues/13) |
| [#193](https://github.com/bradautomates/claude-video/pull/193) | @Anil-matcha | feat: add MuAPI Whisper fallback | **deferred** | MuAPI vendor service; same → [frinsen#13](https://github.com/frinsen/claude-video/issues/13) |
| [#196](https://github.com/bradautomates/claude-video/pull/196) | @AureliaRen | Add DashScope (Alibaba Bailian) transcription backend for networks where Groq/OpenAI are unreachable | **deferred** | DashScope SDK dependency; generic local backend covers self-hosting → [frinsen#13](https://github.com/frinsen/claude-video/issues/13) |
| [#215](https://github.com/bradautomates/claude-video/pull/215) | @Verohomie | Make /watch usable on screen recordings: fix macOS downloads, lift the 720p cap, size frames to the source | **deferred** | 2k-line bundle (quality dial, screen detection, manifest); yt-dlp capability part covered by preflight warnings; fork issue → [frinsen#10](https://github.com/frinsen/claude-video/issues/10) |
| [#235](https://github.com/bradautomates/claude-video/pull/235) | @charles98601-sg | Cache downloads so a repeat run skips the fetch | **deferred** | download cache — design question (growth/cleanup); fork issue → [frinsen#9](https://github.com/frinsen/claude-video/issues/9) |
